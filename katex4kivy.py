...
import threading
if platform == 'android':
    from backend.katex_render import KaTeXRenderer
    from jnius import autoclass
    Bitmap = autoclass("android.graphics.Bitmap")
    BitmapUtil = autoclass("org.katex.BitmapUtil")
    PythonActivity = autoclass("org.kivy.android.PythonActivity")


class KatexImage(Image):
    ...
    def render(self,dt):
        if not self._kr:
            self._kr = KaTeXRenderer(self.on_tex_ready)
