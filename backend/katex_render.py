...
# Java classes
KaTeXRendererJava = autoclass("org.katex.KaTeXRenderer")
...
class RenderCallback(PythonJavaClass):
    __javainterfaces__ = ['org/katex/KaTeXRenderer$RenderCallback']
    __javacontext__ = 'app'
...
class KaTeXRenderer:
    def __init__(self, callback_fn):
        ...
        self.renderer = KaTeXRendererJava(context, self.callback)
